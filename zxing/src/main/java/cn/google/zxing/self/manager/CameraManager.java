...
import cn.google.zxing.PlanarYUVLuminanceSource;
...
import cn.google.zxing.client.android.camera.open.OpenCameraInterface;
import cn.google.zxing.self.callback.PreviewCallback;
import cn.google.zxing.self.core.Scanner;
import cn.google.zxing.self.core.ScannerOptions;

import java.io.IOException;

/**
 * 这个对象包裹相机服务对象即OpenCamera 唯一的访问相机类的类 实现压缩
 *
 * This object wraps the Camera service object and expects to be the only one talking to it. The
 * implementation encapsulates the steps needed to take preview-sized 预览尺寸 images, which are used for
