package cn.google.zxing.self.decode;
...
import cn.google.zxing.RGBLuminanceSource;
import cn.google.zxing.Result;
import cn.google.zxing.common.GlobalHistogramBinarizer;
...
public final class QRDecode {
    ...
    public static void decodeQR(Bitmap srcBitmap, final OnScannerCompletionListener listener) {
        ...
        if (srcBitmap != null) {
            ...
            QRCodeReader reader = new QRCodeReader(null,null);//初始化解析对象
            try {
