package cn.google.zxing.self.core;
...
import cn.google.zxing.self.manager.DecodeFormatManager;

import java.util.Collection;

/**
 * 整个surfaceview 的配置 包括视图和功能  builder装配
...
public final class ScannerOptions {
    ...
    private int frameCornerLength = 28;//扫描框4角长度，单位dp 默认15
