...
import cn.google.zxing.client.android.Contents;
import cn.google.zxing.client.android.Intents;
import cn.google.zxing.client.android.LocaleManager;


import cn.google.zxing.client.result.ParsedResult;
import cn.google.zxing.client.result.ParsedResultType;
...
/**
 * A base class for the Android-specific barcode handlers. These allow the app to polymorphically多态
 * suggest the appropriate actions for each data type.
 *
 * This class also contains a bunch of utility公用 methods to take common actions like opening a URL.
...
public abstract class ResultHandler {
  ...
  private String parseCustomSearchURL() {
    ...
    String customProductSearch = prefs.getString(ZxingConfig.KEY_CUSTOM_PRODUCT_SEARCH,
        null);
